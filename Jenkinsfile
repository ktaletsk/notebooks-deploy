                ...
                script {
                    dir('deploy/tools/railyard') {
                        withEnv(["HOME=${env.WORKSPACE}"]) {
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/R.yaml stacks/Python-datascience.yaml stacks/Python-dataviz.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/julia.yaml stacks/Python-datascience.yaml stacks/Python-dataviz.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/julia.yaml stacks/R.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/octave.yaml stacks/Python-datascience.yaml stacks/Python-dataviz.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/octave.yaml stacks/R.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/octave.yaml stacks/julia.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/java.yaml stacks/scala.yaml stacks/Python-datascience.yaml stacks/Python-dataviz.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/java.yaml stacks/scala.yaml stacks/R.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/java.yaml stacks/scala.yaml stacks/julia.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/java.yaml stacks/scala.yaml stacks/octave.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/cpp.yaml stacks/Python-datascience.yaml stacks/Python-dataviz.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/cpp.yaml stacks/R.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/cpp.yaml stacks/julia.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/cpp.yaml stacks/octave.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/cpp.yaml stacks/java.yaml stacks/scala.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/bash.yaml stacks/Python-datascience.yaml stacks/Python-dataviz.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/bash.yaml stacks/R.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/bash.yaml stacks/julia.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/bash.yaml stacks/octave.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/bash.yaml stacks/java.yaml stacks/scala.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/bash.yaml stacks/cpp.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/tensorflow.yaml stacks/pytorch.yaml stacks/fastai.yaml stacks/Python-datascience.yaml stacks/Python-dataviz.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/tensorflow.yaml stacks/pytorch.yaml stacks/fastai.yaml stacks/R.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/tensorflow.yaml stacks/pytorch.yaml stacks/fastai.yaml stacks/julia.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/tensorflow.yaml stacks/pytorch.yaml stacks/fastai.yaml stacks/octave.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/tensorflow.yaml stacks/pytorch.yaml stacks/fastai.yaml stacks/java.yaml stacks/scala.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/tensorflow.yaml stacks/pytorch.yaml stacks/fastai.yaml stacks/cpp.yaml manifests'
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/tensorflow.yaml stacks/pytorch.yaml stacks/fastai.yaml stacks/bash.yaml manifests'
