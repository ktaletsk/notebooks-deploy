                ...
                script {
                    dir('deploy/tools/railyard') {
                        withEnv(["HOME=${env.WORKSPACE}"]) {
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/Python-datascience.yaml stacks/Python-dataviz.yaml stacks/Python-datascience.yaml stacks/Python-dataviz.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/R.yaml stacks/R.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/julia.yaml stacks/julia.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/octave.yaml stacks/octave.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/java.yaml stacks/scala.yaml stacks/java.yaml stacks/scala.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/cpp.yaml stacks/cpp.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/bash.yaml stacks/bash.yaml manifests'
                            ...
                            sh '$HOME/.local/bin/railyard assemble stacks/base.yaml stacks/tensorflow.yaml stacks/pytorch.yaml stacks/fastai.yaml stacks/tensorflow.yaml stacks/pytorch.yaml stacks/fastai.yaml manifests'
