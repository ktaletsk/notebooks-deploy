                ...
                script {
                    dir('deploy/docker/notebook/stacks') {
                        withEnv(["HOME=${env.WORKSPACE}"]) {
                            ...
                            sh 'railyard assemble -t Dockerfile.template -b base.yaml -a java.yaml -p manifests'
                            sh 'railyard assemble -t Dockerfile.template -b base.yaml -a scala.yaml -p manifests'
